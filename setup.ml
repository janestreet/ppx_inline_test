(* OASIS_START *)
(* DO NOT EDIT (digest: cdf0cff7b987cb2d27cf09b995b6d93e) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "ppx_inline_test";
                      lib_findlib_name = Some "runtime-lib";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\197\021\237z\221\218\139\016\024\148g\169[\223F>";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
